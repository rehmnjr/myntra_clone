...
return `<nav>
    <div class="nav-body">
        <div class="nav-list">
            ...
            <div class="nav-logo">
                <a href="/index.html"><img src="https://aartisto.com/wp-content/uploads/2020/11/myntra-1200x900.png"
                        alt="Logo"></a>
            </div>
            ...
            <div class="nav-link">
                <div class="box box1">
                    ...
                    <section class="men-category-hide hide">
                        <div class="nav-category men-list">
                            <div class="list-div">
        ...
        <div class="nav-category women-list">
            <div class="list-div">
                <ul class="category-list women-color">
                    <a href="">
                        <li>
            ...
            <div class="list-div5">
                ...
                <div class="box box3">
                    <a href="https://www.myntra.com/shop/kids"><span>KIDS</span></a>


                    <section class="kid-category-hide hide3">
        <div class="nav-category kid-list">
            <div class="list-div">
                <ul class="category-list kid-color">
                    <a href="">
                        <li>
                            <h4>Boys Clothing </h4>
                        </li>
            ...
            <div class="list-div5">
                ...
                <div class="box box4">
                    ...
                    <section class="home-category-hide hide4">
        <div class="nav-category home-list">
            <div class="list-div">
                <ul class="category-list home-color">
                    <a href="">
                        <li>
            ...
            <div class="list-div5">
                ...
                <div class="box box5">
                    ...
                    <section class="beauty-category-hide hide5">
                    <div class="nav-category beauty-list">
                        <div class="list-div">
                            <ul class="category-list beauty-color">
                                <a href="">
                                    <li>
                                        <h4>Makeup</h4>
                                    </li>
                ...
                <div class="box box6">
                    <a href=""><span>STUDIO <sup class="new">NEW</sup></span></a>

                    <section class="studio-category hide6">
        <div class="studio-div">
            <div class="studio-cont1">
                <img src="https://constant.myntassets.com/web/assets/img/studio-logo-new.svg" alt="" height="40px">
